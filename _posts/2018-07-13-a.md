...
~~~
jbrette@airship:~$ which go
/usr/bin/go

jbrette@airship:~$ go version
...
~~~
scp -r _dist/linux-arm/ pirate@192.168.1.95:/home/pirate/helm_binaries
~~~
...
jbrette@airship:~/src/k8s.io/helm$ docker build -t $DHUBREPO:$VERSION -f rootfs/Dockerfile.arm32v7 .
